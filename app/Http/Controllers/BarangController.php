...
class BarangController extends Controller
{
            ...
            return  DataTables::of($barang)
                  ...
                  ->editColumn('category.nama', function($data){
                    ...
                    ->addColumn('action', function($row){
                           $btn = '<a class="btn btn-primary" href="/barang-edit/'.(isset($row->id)?$row->id:"").'" style="color:#ffff;display:inline-block;" ><i class="fa-solid fa-pen-to-square"></i> </a>
                                   <a class="btn btn-danger" href="/barang-delete/'.(isset($row->id)?$row->id:"").'" style="color:#ffff;display:inline-block;" ><i class="fa-solid fa-trash"></i></a>';
                            return $btn;
                    })
                    ->rawColumns(['action'])
                    ->make(true);
    ...
    public function edit($id){
        ...
        $barangdata = Barang::with('category')->get()->find($id);
...
{   
   /* $validator = Validator::make($request->all(), [
    ...
    Session::flash('status', 'success');
    Session::flash('message', 'Delete Data Barang Berhasil');
